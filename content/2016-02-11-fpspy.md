title: Python 3 driver for fingerprint scanner GT-511C3
date: 2016-02-11
category: python
slug: fpspy

아두이노, 라즈베리파이 등에서 사용하는 지문 인식 센서 GT-511C3의 파이썬 3 드라이버를 공유합니다. 예전에 아두이노 관련 프로젝트를 하면서 작성했던 코드입니다. 그래서 그 때 프로젝트 상에서 필요한 기능들만 구현했기 때문에 지문 인식 센서의 모든 기능이 다 포함되어 있지는 않습니다.

Github 리파지토리: https://github.com/moonkwonkim/fpspy3
